...
public class MyBatisPlusGenerator {
    ...
    private static DataSourceConfig initDataSourceConfig() {
        ...
        dataSourceConfig.setUrl(props.getStr("jdbc.connectionURL"));
        dataSourceConfig.setDriverName(props.getStr("jdbc.driverClass"));
        dataSourceConfig.setUsername(props.getStr("jdbc.userId"));
        dataSourceConfig.setPassword(props.getStr("jdbc.password"));
    ...
    private static StrategyConfig initStrategyConfig(String[] tableNames) {
        ...
        if (tableNames.length == 1 && tableNames[0].contains("*")){
            String[] likeStr = tableNames[0].split("-");
